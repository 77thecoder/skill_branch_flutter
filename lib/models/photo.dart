...
class Photo {
  ...
  factory Photo.fromJson(Map<String, dynamic> json) => Photo(
    ...
    promotedAt: json["promoted_at"] == null ? DateTime.now() : json["promoted_at"],
    width: json["width"],
    height: json["height"],
    color: json["color"],
    ...
    links: json["links"] == null ? PhotoLinks() : PhotoLinks.fromJson(json["links"]),
    categories: json["categories"] == null ? List<dynamic>() : List<dynamic>.from(json["categories"].map((x) => x)),
    likes: json["likes"] == null ? 0 : json["likes"],
    likedByUser: json["liked_by_user"] == null ? false : json["liked_by_user"],
    currentUserCollections: json["current_user_collections"] == null ? List<dynamic>() : List<dynamic>.from(json["current_user_collections"].map((x) => x)),
